...
public class DataHero {
    private static String[] namaHero = {
            "Ahmad Dahlan",
            "Ahmad Yani",
            "Sutomo",
            "Gatot Soebroto",
    ...
    private static String[] deskripsiHero = {
    ...
    public  static ArrayList<ModelHero> getListHero(){
        ModelHero modelHero = null;
        ArrayList<ModelHero> list = new ArrayList<>();
        for (int i = 0; i < namaHero.length; i++){
            modelHero = new ModelHero();
            modelHero.setNamaHero(namaHero[i]);
            modelHero.setDeskripsiHero(deskripsiHero[i]);
            modelHero.setGambarHero(gambarHero[i]);
            list.add(modelHero);
        }
